...
command $$create_config_text_scene_object(property $stage : stage)
{
	...
	$$create_ui_toggle_button($stage.object[@ボタン_コンフィグ_文字設定_フォント_詳細設定], _config_text_moji_font_other_btn, 486, 253, @ボタン_コンフィグ_文字設定_フォント_詳細設定, <OBJBTN_GROUP_NO_EXCALL>, 1, $$get_config_other_prefont_type)
